...
const UploadButton = ({ handleFileChange }: UploadButtonProps) => {
    return (
        <FileUpload.Root key={Math.random()} accept={["image/png", "image/jpeg", "application/pdf"]} onFileChange={handleFileChange} maxFileSize={10 * 1024 * 1024} unstyled flex={{ base: "none", lgDown: "1" }}>
