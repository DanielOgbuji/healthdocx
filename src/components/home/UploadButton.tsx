...
const UploadButton = ({ handleFileChange }: UploadButtonProps) => {
    return (
        <FileUpload.Root accept={["image/png", "image/jpeg", "application/pdf"]} onFileChange={handleFileChange} maxFileSize={10 * 1024 * 1024} maxFiles={1} unstyled flex={{ base: "none", lgDown: "1" }}>
